...
# print("⚡ Solana Alpha Engine Running")
...
#                 if trade.HasField("Buy"):
#                     buy_amount = trade.Buy.Amount

#                 if trade.HasField("Sell"):
#                     sell_amount = trade.Sell.Amount
...
#                     print("\n🔥 VOLUME SPIKE")
#                     print("Token:", token)
#                     print("Trades:", token_trades[token])
#                     print("USD Volume:", token_volume[token])
